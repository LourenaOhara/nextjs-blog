...
export const MediumIcon = ({ className, ...rest }) => (
  ...
  >
    <path
      fill="currentColor"
      d="M23.773 12C12.855 12 12 12.854 12 23.773v16.454C12 51.145 12.855 52 23.773 52h16.454C51.145 52 52 51.146 52 40.227V23.773C52 12.854 51.146 12 40.227 12H23.773zm-2.605 4h21.664c4.793 0 5.168.375 5.168 5.168v21.664C48 47.625 47.624 48 42.832 48H21.168C16.375 48 16 47.624 16 42.832V21.168c0-4.793.375-5.168 5.168-5.168zm5.117 8.59a7.41 7.41 0 1 0 .001 14.821 7.41 7.41 0 0 0 0-14.821zm11.819.357c-2.026 0-3.668 3.158-3.668 7.053s1.642 7.053 3.668 7.053c2.026 0 3.667-3.159 3.667-7.053 0-3.895-1.641-7.053-3.667-7.053zm5.697.754c-.704 0-1.276 2.82-1.276 6.299 0 3.479.572 6.299 1.276 6.299.705 0 1.273-2.82 1.273-6.299 0-3.479-.57-6.299-1.273-6.299z"
    />
  </svg>
);
