...
import { GithubIcon, LinkedInIcon, SunIcon, MoonIcon, MediumIcon } from './Icons'
        ...
        <header className='w-full px-32 py-8 font-medium flex items-center justify-between
         dark:text-light relative'>
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                <nav>
                    <CustomLink href="/" title="Início" className='mr-6' />
                    <CustomLink href="/about" title="Sobre" className='mr-6' />
                    <CustomLink href="/portifolio" title="Portifólio" className='mr-6' />
                </nav>
...

        {
            ...
            backdrop-blur-md py-32'>
                <nav className='flex items-center flex-col justify-center'>
                    <CustomMobileLink href="/" title="Início" className='mr-6' toggle={handleClick} />
                    <CustomMobileLink href="/about" title="Sobre" className='mr-6' toggle={handleClick} />
                    <CustomMobileLink href="/portifolio" title="Portifólio" className='mr-6' toggle={handleClick} />
                </nav>
